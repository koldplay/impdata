...
public class CSVStockTradeReaderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/JOB/ClientStockTrade/csvstocktradereader.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CSVStockTradeReaderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/JOB/ClientStockTrade/csvstocktradereader.wsdl");
        }
        WSDL_LOCATION = url;
    }
