...
public class CSVStockTradeReaderService extends Service {
    ...
    public final static QName SERVICE = new QName("http://default_package/", "CSVStockTradeReaderService");
    public final static QName CSVStockTradeReaderPort = new QName("http://default_package/", "CSVStockTradeReaderPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/JOB/StockTradeClient/csvstocktradereader.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CSVStockTradeReaderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/JOB/StockTradeClient/csvstocktradereader.wsdl");
        }
        WSDL_LOCATION = url;
    }
