...
public class UserCSVReader {
	...
	@WebMethod
	@RequestWrapper(localName = "getAllUsers", targetNamespace = "http://userproduct.bizruntime.com/", className = "com.bizruntime.userproduct.GetAllUsers")
	@ResponseWrapper(localName = "getAllUsersResponse", targetNamespace = "http://userproduct.bizruntime.com/", className = "com.bizruntime.userproduct.GetAllUsersResponse")
	@WebResult(name = "return", targetNamespace = "")
	public java.util.List<com.bizruntime.userproduct.User> getAllUsers() throws FileReaderException ,ResourceNotFoundException{
