...
var DepartmentComponent = (function () {
    function DepartmentComponent(router, route) {
        this.router = router;
        this.route = route;
        this.departments = [
            { "id": 1, "name": "angular" },
    ...
    DepartmentComponent.prototype.onSelect = function (department) {
        //this.router.navigate(['/deparment' , department.id]);
        this.router.navigate(department.id), { relativeTo: this.route };
    };
    DepartmentComponent.prototype.isSelected = function (department) {
