	...
	public Connection getDBConnection() throws DataReadException, DataResourcesNotFoundException {
		...
		if (inputStream == null) {
			...
			try {
				...
				dataSource.setDriverClassName(properties.getProperty("DB01.driverClassName"));
				dataSource.setUrl(properties.getProperty("DB01.url"));
				dataSource.setUsername(properties.getProperty("DB01.username"));
				dataSource.setPassword(properties.getProperty("DB01.password"));
