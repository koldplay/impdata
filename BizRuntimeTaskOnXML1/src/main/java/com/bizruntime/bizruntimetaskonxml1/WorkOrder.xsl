		...
		<Workorder>
			...
			<Provider>
				...
				<SourceProperties>
					<Properties>
						...
						<xsl:value-of select="DATA2SC/CALL/ATTR/@PRO_NAME"></xsl:value-of>
						</xsl:attribute>
					</Properties>
					<Properties>
						<xsl:attribute name="Category">
						<xsl:value-of select="DATA2SC/CALL/ATTR/@STATUS" />
						</xsl:attribute>
					</Properties>
					<Properties>
			...
			<xsl:if test="DATA2SC/CALL[@SUB]">
				<Address>
					...
					<AddressName>
						<xsl:value-of select="DATA2SC/@TRADE"></xsl:value-of>
					</AddressName>
					<Street1></Street1>
					<Street2></Street2>
					<City></City>
					...
					<Contacts>
						<Contact>
							<xsl:value-of select="DATA2SC/CALL"/>
								<Name>
								...
								<KVP>
									<xsl:value-of select="ATTR/@TYPE"></xsl:value-of>
								</KVP>
			...
			<Division></Division>
			<ScheduledDate>
				<xsl:value-of select="DATA2SC/@DATATIME" />
			</ScheduledDate>
			<CallStatus>
				<xsl:value-of select="DATA2SC/@STATUS" />
			</CallStatus>
			<CallType>
				<xsl:value-of select="DATA2SC/@TYPE" />
			</CallType>
			<CreatedBy>
							...
							<xsl:for-each select="DATA2SC">
								...
								<Manufacturer>
									...
									<Model>
										...
										<Description>
											<xsl:value-of select="DATA2SC/CALL/ATTR"></xsl:value-of>
										</Description>
									</Model>
								</Manufacturer>
