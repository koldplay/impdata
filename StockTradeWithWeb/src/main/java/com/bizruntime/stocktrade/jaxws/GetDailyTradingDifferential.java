...
@XmlRootElement(name = "getDailyTradingDifferential", namespace = "http://stocktrade.bizruntime.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDailyTradingDifferential", namespace = "http://stocktrade.bizruntime.com/")
